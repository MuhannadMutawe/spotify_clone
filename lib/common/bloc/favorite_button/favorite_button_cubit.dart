...
class FavoriteButtonCubit extends Cubit<FavoriteButtonState> {
  FavoriteButtonCubit(
    this.addOrRemoveFavoriteSongUseCase,
    this.isFavoriteSongUseCase,
  ...
  Future<void> loadInitialState(String songId) async {
    var isFavorite = await isFavoriteSongUseCase.call(songId);

    emit(FavoriteButtonState.updated(isFavorite));
  }
